...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/media-downloader'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in media-downloader
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in media-downloader but are NOT registered "
