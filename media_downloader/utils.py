...
def get_skills_path() -> str:
    skills_dir = files("media_downloader") / "skills"
...
def get_mcp_config_path() -> str:
    mcp_config_file = files("media_downloader") / "mcp_config.json"
                ...
                try:
                    with open(skill_file, "r") as f:
                        ...
                        if content.startswith("---"):
                            ...
                            tag_name = skill_id.replace("media-downloader-", "")
                            tags = ["media-downloader", tag_name]
